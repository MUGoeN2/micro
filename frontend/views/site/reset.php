...
<div class="row">
    <div class="col-md-2  col-md-offset-4 col-xs-6" >
        <?= $form->field($model, 'short_mess')->textInput(['placeholder'=>'短信验证码']) ?>
    </div>
...
<div class="row">
    <div class="col-md-4  col-md-offset-4 col-xs-12 " >
        <?= $form->field($model, 'password')->passwordInput(['placeholder'=>'输入手密码']) ?>
    </div>
</div>
<div class="row">
    <div class="col-md-4  col-md-offset-4 col-xs-12 ">
        <?= $form->field($model, 're_password')->passwordInput(['placeholder'=>'重复密码']) ?>
    </div>
</div>
<br>
<div class="row">
