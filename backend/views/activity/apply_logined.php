...
<div class="activity-form" style="font-family: 微软雅黑">
    ...
    <div class="row" >
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="hidden">
                <?= $form->field($activityBaoming, 'uid')->textInput(['value' => Yii::$app->user->id]) ?>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <?= $form->field($activityBaoming, 'tel')->textInput(['value' => $userMess->tel]) ?>
        </div>
    </div>
<!--    <div class="row">-->
<!--        <div class="col-md-6 col-md-offset-3">-->
...
<!--                </div>-->
<!--                <div class="col-sm-3">-->
<!--                    <button type="button" class="btn btn-danger" style="width: 100%">获取手机验证码</button>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
